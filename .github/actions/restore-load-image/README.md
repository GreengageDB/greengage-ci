...
- name: Restore and load Docker image
  uses: greengagedb/greengage-ci/.github/actions/restore-load-image@feat/image_save_tar_option
  with:
    version: '6' # or '7'
    target_os: 'ubuntu'
...
- `greengagedb/greengage-ci/.github/actions/restore-load-image/action.yml@feat/image_save_tar_option`
