...
async function run() {
  try {
    ...
    const targetOs = getInput("target_os", { required: true });
    const targetOsVersion = getInput("target_os_version") || "";
    const optimizer = getInput("optimizer", { required: true });
    const dumpDb = getInput("dump_db") || "";
    const version = getInput("version") || "";
    saveState("dump_db", dumpDb);
    saveState("target_os", targetOs);
    saveState("target_os_version", targetOsVersion);
    saveState("version", version);
    saveState("container_name", "regress");
    saveState("log_name", "regression");
